...
describe('errable', function () {
  ...
  describe('ifNotErrAsync', function () {
    it('should work for promise return value', function (done) {
      var fn = jest.fn().mockImplementation(function () {
        return Promise.resolve(Mx.val(fixture));
      });
      var valFix = {};
      var val = Mx.val(valFix);
  ...
  describe('ifErrAsync', function () {
    it('should work for promise return value', function (done) {
      var fn = jest.fn().mockImplementation(function () {
        return Promise.resolve(Mx.err(fixture));
      });
      var valFix = {};
      var err = Mx.err(valFix);
  ...
  describe('cata', function () {
    it('should cata a Val', function () {
      var vFn = jest.fn().mockImplementation(function () {
        return fixture;
      });
      var eFn = jest.fn();
      var valFix = {};
    ...
    it('should cata a Err', function () {
      var vFn = jest.fn();
      var eFn = jest.fn().mockImplementation(function () {
        return fixture;
      });
      var valFix = {};
      var err = Mx.err(valFix);
